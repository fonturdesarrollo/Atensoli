...
namespace Atensoli
{
    public partial class CorrespondenciaInternaRecepcionGerencia
	{
        public static int InsertarSeguimientoCorrespondencia(CCorrespondenciaInternaRecepcionGerencia objetoCorrespondencia)
        {
        ...
        public static DataSet ObtenerCorrespondenciaInterna(int correspondenciaID, int gerenciaID)
        {
            SqlParameter[] dbParams = new SqlParameter[]
                {
            ...
            return DBHelper.ExecuteDataSet("usp_CorrespondenciaInterna_ObtenerCorrespondenciaGerencia", dbParams);
        }
        public static DataSet ObtenerHistorialCorrespondenciaGerencia(int correspondenciaID)
        {
            ...
            return DBHelper.ExecuteDataSet("usp_CorrespondenciaInternaGerencia_HistorialCorrespondencia", dbParams);
        }
    }
}