<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorrespondenciaInternaCreacion.aspx.cs" Inherits="Atensoli.CorrespondenciaInternaCreacion" %>
...
<html>
	<head>
		<title>Correspondencia | Creación de Correspondencia Interna</title>
		<meta charset="utf-8" />
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<!-- Header -->
								<header id="header">
									<a class="logo"><strong><asp:Label runat ="server" ID ="lblTitulo" Text="Creación de Correspondencia Interna"></asp:Label></strong></a>
									<ul class="icons">
							...
							<form runat ="server" id ="principal">
								<section>
									<p></p>
										...
										<div class="12u$">
											<ul class="actions">
												<li><asp:Button Text="Registrar correspondencia interna" runat="server" ID ="btnGuardar"  CssClass ="special" OnClick="btnGuardar_Click"  /></li>
