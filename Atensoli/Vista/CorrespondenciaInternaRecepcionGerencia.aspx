<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorrespondenciaInternaRecepcionGerencia.aspx.cs" Inherits="Atensoli.CorrespondenciaInternaRecepcionGerencia" %>
...
<html>
	<head>
		<title>Correspondencia | Actualizar correspondencia interna</title>
		<meta charset="utf-8" />
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<!-- Header -->
								<header id="header">
										<strong><asp:Label runat ="server" ID ="lblTitulo" Text="Actualizar correspondencia interna"></asp:Label></strong>
									<ul class="icons">
									</ul>
								</header>
							<!-- Content -->
