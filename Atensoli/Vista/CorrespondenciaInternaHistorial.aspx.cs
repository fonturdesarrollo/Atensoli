...
namespace Atensoli
{
    public partial class CorrespondenciaInternaHistorial : System.Web.UI.Page
	{
        ...
        private void CargarSeguimientoHistorial()
        {
            try
            {
                DataSet ds = CorrespondenciaInternaRecepcionGerencia.ObtenerHistorialCorrespondenciaGerencia(Convert.ToInt32(Session["CodigoCorrespondenciaSeleccionada"].ToString()));
