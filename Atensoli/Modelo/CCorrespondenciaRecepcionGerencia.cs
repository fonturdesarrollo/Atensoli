...
namespace Atensoli
{
    public class CCorrespondenciaRecepcionGerencia
    {
        public CCorrespondenciaRecepcionGerencia()
        {

        }

        public CCorrespondenciaRecepcionGerencia(int _correspondenciaID, int _tipoInstruccionCorrespondenciaID, string _observacionesSeguimientoCorrespondencia, int _correspondenciaEstatusID, int _gerenciaID, int _seguridadUsuarioDatosID, int _gerenciaRemitenteID)
        {
